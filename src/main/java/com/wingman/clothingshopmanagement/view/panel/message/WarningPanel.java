...
public class WarningPanel extends CustomPanel {
    /**
    ...
    public static void show(String mesage) {
        GlassPanePopup.showPopup(new WarningPanel(mesage), "warning");
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setForeground(new java.awt.Color(238, 64, 76));
        ...
        okayBtn.setBackground(new java.awt.Color(238, 64, 76));
        okayBtn.setForeground(new java.awt.Color(255, 255, 255));
        okayBtn.setText("CLOSE");
        okayBtn.setBorderColor(new java.awt.Color(238, 64, 76));
        okayBtn.setColor(new java.awt.Color(238, 64, 76));
        okayBtn.setColorClick(new java.awt.Color(187, 50, 59));
        okayBtn.setColorOver(new java.awt.Color(238, 64, 76));
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(content, javax.swing.GroupLayout.DEFAULT_SIZE, 117, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void okayBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okayBtnActionPerformed
        GlassPanePopup.closePopup("warning");
