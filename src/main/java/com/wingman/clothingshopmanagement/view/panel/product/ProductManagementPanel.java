...
public class ProductManagementPanel extends javax.swing.JPanel {
    ...
    private void displayProducts(OrderBy order, String filter, boolean reverse) {
        ...
        products.sort((o1, o2) -> {
            return switch (order) {
                case ID -> Long.compare(o1.getProductId(), o2.getProductId());
                case NAME -> o1.getName().compareTo(o2.getName());
                case BRAND -> o1.getBrand().compareTo(o2.getBrand());
                case GENDER -> o1.getGender().toString().compareTo(o2.getGender().toString());
                case STOCK -> Integer.compare(o1.getStock(), o2.getStock());
                default -> Long.compare(o1.getProductId(), o2.getProductId());
            };
        });
        ...
        for (Product product: products) {
            addProductPanel(new ProductPanel(this, product));
        }
    ...
    private void initComponents() {
        ...
        unselectAllBtn.setForeground(new java.awt.Color(171, 112, 242));
        unselectAllBtn.setText("Unselect all");
        unselectAllBtn.setBorderColor(new java.awt.Color(171, 112, 242));
        unselectAllBtn.setColorClick(java.awt.Color.white);
        unselectAllBtn.setColorOver(java.awt.Color.white);
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(unselectAllBtn, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(unselectAllBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
    ...
    private com.wingman.clothingshopmanagement.view.components.CustomButton unselectAllBtn;
